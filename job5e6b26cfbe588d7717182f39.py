...
try: 
	...
	BostonHousingPrices_AutoML = tpot_execution.Tpot_execution.run(["5e6b26cfbe588d7717182f3b"],{"5e6b26cfbe588d7717182f3b": BostonHousingPrices_AutoFE}, "5e6b26cfbe588d7717182f3c", spark,json.dumps( {"model_type": "regression", "label": "MEDV", "features": ["CRIM", "ZN", "INDUS", "CHAS", "NOX", "RM", "AGE", "DIS", "RAD", "TAX", "PTRATIO", "B", "LSTAT"], "percentage": "40", "executionTime": "5", "sampling": "0", "sampling_value": "", "run_id": "", "model_id": "5e6b5957be588d77171831e1", "ProjectName": "ML Sample Problems", "PipelineName": "BostonHousingPrices", "pipelineId": "5e6b26cfbe588d7717182f39", "userid": "5df78f4be2f2eff24740bbd7", "runid": "", "url_ResultView": "http://13.68.212.36:3200", "experiment_id": "480623611921769"}))
